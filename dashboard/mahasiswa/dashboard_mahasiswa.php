    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div id="dashboard" class="content active">
                ...
                <!-- Grafik Mahasiswa dan Dosen -->
                <h3>Jumlah Mahasiswa dan Dosen</h3>
                <canvas id="mahasiswaDosenChart" width="400" height="200"></canvas>
            </div>
...
<script>
    ...
    if (confirmation) {
        // Jika pengguna mengonfirmasi, arahkan ke frontend.php
    ...
    function toggleSidebar() {
        ...
        // Tambahkan kelas untuk menyembunyikan sidebar dan menyesuaikan margin konten utama
